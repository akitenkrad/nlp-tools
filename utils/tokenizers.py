...
class WordTokenizer(Tokenizer):
    ...
    def __init__(self, pad='<pad>', max_sent_len=-1, language=Lang.ENGLISH,
    ...
    def tokenize(self, text: str, disable_max_len=False) -> List[Union[str, Tuple[str, str]]]:
        '''tokenize a sentence
...
class CharTokenizer(Tokenizer):
    ...
    def __init__(self, pad='<pad>', max_sent_len=-1, max_word_len=-1, language=Lang.ENGLISH,
                 remove_stopwords=False, remove_punctuations=True, stemming=False):
        self.PAD: str = pad
        self.max_sent_len: int = max_sent_len
