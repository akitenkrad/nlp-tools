...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        out = self.relu(self.dropout(self.batch_norm_0(self.conv_0(x))))
        out = self.relu(self.dropout(self.batch_norm_1(self.conv_1(out))))
        out = self.relu(self.dropout(self.batch_norm_1(self.conv_2(out))))
        out = self.relu(self.dropout(self.batch_norm_1(self.conv_3(out))))
...
class Decoder(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.relu(self.dropout(self.batch_norm_0(self.conv_t_0(out))))
        out = self.relu(self.dropout(self.batch_norm_0(self.conv_t_1(out))))
        out = self.relu(self.dropout(self.batch_norm_1(self.conv_t_2(out))))
